...
{if $snippetAddressesTitleCreate} {* Shipping-Address *}
                {* Street *}
...
{if $snippetAddressesTitleEdit} {* Billing-Address *}
                {* Street *}
                {block name='frontend_address_form_input_street'}
                    <div class="address--street">
                        <input autocomplete="section-billing billing street-address"
...
{block name='frontend_address_required'}
	...
	<p><a href="#" onClick="window.open('https://www.dhl.de/de/privatkunden/dhl-standorte-finden.html','DHL Postfinder','toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=yes,height=400,width=600'); return false;"  title="Packstation finden">Packstation finden</a></p>
    </div>
{/block}
